...
class DateSelector {
    ...
    constructor() {
        this.minDate = "1921-04-25T20:00";
        this.maxDate = "2018-10-23T06:15";
    ...
    getQueryParameters() {
        let lowerDate = new Date(d3.select("#startDate").property("value")).getTime() / 1000;
        let upperDate = new Date(d3.select("#stopDate").property("value")).getTime() / 1000;
